...
public class TerminalFragment extends Fragment implements ServiceConnection, SerialListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
       View view = inflater.inflate(R.layout.fragment_terminal, container, false);
        gonderr = view.findViewById(R.id.gonder);
        ...
        gonderr.setOnClickListener(new View.OnClickListener() {
            ...
            {
               // byte[] bytes = Xml.Encoding.ASCII.GetBytes( receiveText.getText().toString());
       ...
       // gonderr.setOnClickListener(v -> receive(receiveText.getText().toString());
   ...
   @Override
    ...
    private void receive(byte[] data) {
        ...
        ( (MainActivity) getActivity()).tarti = new String(data);
    ...
    class ControlLines {
        ...
        private ToggleButton rtsBtn, ctsBtn, dtrBtn, dsrBtn, cdBtn, riBtn,gonder;
